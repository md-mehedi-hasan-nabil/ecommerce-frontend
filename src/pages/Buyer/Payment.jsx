  ...
  return (
    <BuyerLayout>
      ...
      <div className="flex justify-center items-center">
        {showPayment ? (
          <div className="bg-white mt-10 px-8 pb-8 rounded-md shadow-lg">
            ...
            <div className="grid grid-cols-12 gap-6 mt-4">
              <img
                className="col-span-4 w-16 h-16 object-cover cursor-pointer hover:scale-105"
                src={a}
                alt=""
              />
              <img
            ...
            <button
              ...
              className="mt-4 bg-purple-500 hover:bg-purple-700 text-white font-medium py-2 w-full rounded-md"
            >
              Pay{!payment ? "" : "৳"} {payment}
            </button>
          ...
          <div className="text-center mt-10">
            ...
            <Link to="/">
              <Button className="bg-green-500 hover:bg-green-600 w-full py-2 rounded-md text-white font-medium text-lg mt-3">
                Go Back
              </Button>
            </Link>
          </div>
